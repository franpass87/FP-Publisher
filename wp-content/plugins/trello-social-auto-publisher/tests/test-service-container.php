...
$tests = array(
    ...
    'resolves_nested_dependencies' => function () {
        ...
        $container->set( 'dependent', function ( TTS_Service_Container $c ) {
            return $c->get( 'config' );
        } );
    ...
    'detects_circular_dependencies' => function () {
        ...
        $container = new TTS_Service_Container();
        $container->set( 'a', function ( TTS_Service_Container $c ) {
            return $c->get( 'b' );
        } );
        $container->set( 'b', function ( TTS_Service_Container $c ) {
            return $c->get( 'a' );
        } );
