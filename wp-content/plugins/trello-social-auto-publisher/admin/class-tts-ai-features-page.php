        ...
        wp_localize_script(
            ...
            array(
                ...
                'strings' => array(
                    ...
                    'posts_missing_metrics'       => __( 'Posts missing metrics:', 'fp-publisher' ),
                    'platform_breakdown'          => __( 'Platform Breakdown:', 'fp-publisher' ),
                    'posts_with_metrics'          => __( 'Posts with metrics:', 'fp-publisher' ),
                    'total_interactions'          => __( 'Total interactions:', 'fp-publisher' ),
                    'avg_interactions_per_post'   => __( 'Avg. interactions per post:', 'fp-publisher' ),
                    'posts_missing_data'          => __( 'Posts missing metric data:', 'fp-publisher' ),
                    'metrics_not_available'       => __( 'Metrics not available for this platform yet.', 'fp-publisher' ),
                    'metric_total'                => __( 'Total', 'fp-publisher' ),
                    'metric_average'              => __( 'Average', 'fp-publisher' ),
                    'missing_metrics_label'       => __( 'Missing metrics:', 'fp-publisher' ),
                    'no_metrics_found'            => __( 'No metrics available for the analyzed posts.', 'fp-publisher' ),
                    'top_media'                   => __( 'Top Performing Posts:', 'fp-publisher' ),
                    'untitled_post'               => __( '(untitled)', 'fp-publisher' ),
                    'interactions'                => __( 'Interactions:', 'fp-publisher' ),
                    'view_post'                   => __( 'View Post', 'fp-publisher' ),
                    'not_available'               => __( 'Not available', 'fp-publisher' ),
                    'no_recommendations'          => __( 'No recommendations available yet.', 'fp-publisher' ),
                    'impact_label'                => __( 'Impact', 'fp-publisher' ),
                    'effort_label'                => __( 'Effort', 'fp-publisher' ),
