...
final class TikTokException extends RuntimeException
{
    ...
    {
        return new self($message, 500, 'unexpected', true);
    }
    ...
    private static function shouldRetry(int $statusCode, string $errorCode): bool
    {
        ...
        return in_array($errorCode, ['rate_limit_exceeded', 'service_unavailable', 'server_error'], true);
    }
}
